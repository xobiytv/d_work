  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
     ...
     text-secondary-white"
      ...
      >
        <span className="font-bold text-[#fff]">Metaverse </span>
        ...
        of today, using only
        <span className="font-bold text-[#fff]"> VR </span>
        devices you can easily explore the metaverse world you want, turn your
        dreams into reality. Let's
        <span className="font-bold text-[#fff]"> explore </span> the madness of
